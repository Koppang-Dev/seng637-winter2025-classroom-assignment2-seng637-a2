...
# 1 Introduction
This lab report outlines our test case design and our testing strategy for unit testing. For this assignment, we used Equivalence Partitioning and Boundary Analysis as our black-box testing techniques. Additionally, we have described how we will test each function, how we partitioned it, and how we will combine boundary analysis. In the `Test Cases Developed` section, we explain each test we developed for the given functions in greater detail. 
...
## **1️⃣ Combine(Range range1, Range range2)**
...
| **Error** | 🚨 It is taking the smallest values from both ranges to create a new range. |
