...
| **Test Name**                                      | **Method Being Tested**               | **Description**                                               | **Expected Behavior**                                        | **Edge Cases Covered**                                       |
|----------------------------------------------------|---------------------------------------|---------------------------------------------------------------|--------------------------------------------------------------|--------------------------------------------------------------|
| `calculateColumnTotalWithValidArray`              | `DataUtilities.calculateColumnTotal`  | Calculates column total for valid 2D array                    | Returns correct sum                                          | None                                                         |
| `calculateColumnTotalWithNullData`                | `DataUtilities.calculateColumnTotal`  | Calculates column total with null input                       | Throws `NullPointerException`                               | Null data                                                   |
| `calculateColumnTotalWithNegativeIndex`           | `DataUtilities.calculateColumnTotal`  | Calculates column total with negative index                   | Throws `ExpectationError`                                   | Negative index                                              |
| `calculateColumnTotalWithOutOfIndex`              | `DataUtilities.calculateColumnTotal`  | Calculates column total with out-of-bounds index              | Throws `ExpectationError`                                   | Index greater than column count                             |
| `calculateRowTotalWithValidArray`                 | `DataUtilities.calculateRowTotal`     | Calculates row total for valid 2D array                        | Returns correct sum                                          | None                                                         |
| `calculateRowTotalWithNullData`                   | `DataUtilities.calculateRowTotal`     | Calculates row total with null input                          | Throws `NullPointerException`                               | Null data                                                   |
| `calculateRowTotalWithNegativeIndex`              | `DataUtilities.calculateRowTotal`     | Calculates row total with negative index                      | Throws `ExpectationError`                                   | Negative index                                              |
| `calculateRowTotalWithOutOfIndex`                 | `DataUtilities.calculateRowTotal`     | Calculates row total with out-of-bounds index                 | Throws `ExpectationError`                                   | Index greater than row count                                |
| `CreateNumberArrayForValidInput`                  | `DataUtilities.createNumberArray`     | Creates `Number[]` from valid `double[]`                     | Returns expected `Number[]`                                | None                                                         |
| `CreateNumberArrayForNullInput`                   | `DataUtilities.createNumberArray`     | Creates `Number[]` from null input                           | Throws `IllegalArgumentException`                          | Null input                                                  |
| `CreateNumberArrayForAllZeroInput`                | `DataUtilities.createNumberArray`     | Creates `Number[]` from array of all zeros                   | Returns correct `Number[]`                                 | All zero input                                              |
| `CreateNumberArrayForEmptyArray`                  | `DataUtilities.createNumberArray`     | Creates `Number[]` from empty array                          | Returns empty `Number[]`                                   | Empty array                                                 |
| `CreateNumberArrayForOneInput`                    | `DataUtilities.createNumberArray`     | Creates `Number[]` from single-element array                 | Returns correct `Number[]`                                 | Single-element array                                        |
| `CreateNumberArrayForNegativeInput`               | `DataUtilities.createNumberArray`     | Creates `Number[]` from negative numbers                     | Returns correct `Number[]`                                 | All negative numbers                                        |
| `CreateNumberArrayForPositiveInput`               | `DataUtilities.createNumberArray`     | Creates `Number[]` from positive numbers                     | Returns correct `Number[]`                                 | All positive numbers                                        |
| `CreateNumberArrayForPositiveAndNegativeInput`    | `DataUtilities.createNumberArray`     | Creates `Number[]` from mixed positive and negative numbers  | Returns correct `Number[]`                                 | Mixed positive and negative values                          |
| `CreateNumberArray2DForValidInput`                | `DataUtilities.createNumberArray2D`   | Creates `Number[][]` from valid `double[][]`                 | Returns correct `Number[][]`                               | None                                                         |
| `CreateNumberArray2DForNullInput`                 | `DataUtilities.createNumberArray2D`   | Creates `Number[][]` from null input                         | Throws `IllegalArgumentException`                          | Null input                                                  |
| `CreateNumberArray2DForEmptyArray`                | `DataUtilities.createNumberArray2D`   | Creates `Number[][]` from empty 2D array                     | Returns empty `Number[][]`                                 | Empty array                                                 |
| `CreateNumberArray2DForAllZeroInput`              | `DataUtilities.createNumberArray2D`   | Creates `Number[][]` from all-zero 2D array                  | Returns correct `Number[][]`                               | All zero values                                             |
| `CreateNumberArray2DForMixedPositiveAndNegativeInput` | `DataUtilities.createNumberArray2D` | Creates `Number[][]` with mixed positive & negative values   | Returns correct `Number[][]`                               | Mixed positive and negative values                          |
| `CreateNumberArray2DForSingleRow`                 | `DataUtilities.createNumberArray2D`   | Creates `Number[][]` with a single row                       | Returns correct `Number[][]`                               | Single-row input                                            |
| `CreateNumberArray2DForSingleColumn`              | `DataUtilities.createNumberArray2D`   | Creates `Number[][]` with a single column                    | Returns correct `Number[][]`                               | Single-column input                                         |
| `getCumulativePercentagesForValidData`           | `DataUtilities.getCumulativePercentages` | Computes cumulative percentages from valid dataset        | Returns correct cumulative percentages                     | None                                                         |
| `getCumulativePercentagesForSingleDataPoint`     | `DataUtilities.getCumulativePercentages` | Computes cumulative percentage with one data point       | Returns 1.0                                                 | Single data point                                           |
| `getCumulativePercentagesForNullData`            | `DataUtilities.getCumulativePercentages` | Computes cumulative percentages with null dataset        | Throws `IllegalArgumentException`                          | Null input                                                  |

## RangeTest Summary

| **Test Name**                                   | **Method Being Tested**         | **Description**                                        | **Expected Behavior**                                  | **Edge Cases Covered**                                  |
|-------------------------------------------------|---------------------------------|--------------------------------------------------------|--------------------------------------------------------|---------------------------------------------------------|
| `newRangeShouldBeNull`                          | `Range.combine`                 | Combines two `null` ranges                             | Returns `null`                                         | Both ranges are `null`                                  |
| `returnOtherRange`                              | `Range.combine`                 | Combines `null` with a valid range                    | Returns the valid range                                | One range is `null`                                    |
| `createRangeWithBothPositive`                   | `Range.combine`                 | Combines two valid ranges                             | Returns the correctly merged range                    | Overlapping and non-overlapping ranges                 |
| `constrainWithValueInsideRange`                 | `Range.constrain`               | Constrains value inside range                         | Returns the same value                                | Value within the range                                 |
| `constrainWithValueBelowLower`                  | `Range.constrain`               | Constrains value below lower bound                    | Returns lower bound                                   | Value below range                                      |
| `constrainWithValueAboveUpper`                  | `Range.constrain`               | Constrains value above upper bound                    | Returns upper bound                                   | Value above range                                      |
| `intersectsForOneBound`                         | `Range.intersects`              | Checks intersection when one bound overlaps           | Returns `true`                                        | Partial overlap                                        |
| `intersectsIsFalse`                             | `Range.intersects`              | Checks intersection when ranges do not overlap        | Returns `false`                                       | Non-overlapping ranges                                |
| `intersectsWithImproperRange`                   | `Range.intersects`              | Checks intersection with invalid range (`low > high`) | Throws `IllegalArgumentException`                     | Improper range input                                  |
| `intersectsRangeWithin`                         | `Range.intersects`              | Checks if a range is completely inside another        | Returns `true`                                        | Fully contained range                                 |
| `intersectsRangeOutside`                        | `Range.intersects`              | Checks if a larger range completely contains another  | Returns `true`                                        | Larger range encapsulating smaller one                |
| `expandWithValueLargerThanUpper`                | `Range.expandToInclude`         | Expands range with a value above the upper bound     | Updates upper bound, lower bound remains the same     | Value greater than upper bound                        |
| `expandWithValueSmallerThanLower`               | `Range.expandToInclude`         | Expands range with a value below the lower bound     | Updates lower bound, upper bound remains the same     | Value less than lower bound                           |
| `expandWithValueInsideRange`                    | `Range.expandToInclude`         | Expands range with a value inside range              | No change in range                                    | Value inside the range                                |
| `GetLengthForPositiveValues`                    | `Range.getLength`               | Computes length for a range with positive values     | Returns the correct length                           | Standard positive range                               |
| `GetLengthForZeroLength`                        | `Range.getLength`               | Computes length for a zero-length range              | Returns `0.0`                                        | Upper and lower bounds are the same                  |
| `GetLengthForNegativeLowerBound`                | `Range.getLength`               | Computes length for a range crossing zero            | Returns correct positive length                      | Negative lower bound, positive upper bound           |
| `GetLengthForFullyNegativeBounds`               | `Range.getLength`               | Computes length for a fully negative range           | Returns correct positive length                      | Fully negative range                                 |
